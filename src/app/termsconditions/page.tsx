  ...
  return (
    <div className="py-10 px-20 space-y-5">
      <h1 className=" text-2xl text-center font-semibold">
        Terms and Conditions for OFFBEAT TECHNET PRIVATE LIMITED
      </h1>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1">
          <p className="text-xl">You are specifically restricted from all of the following:</p>
...
<p>
  This Website is provided &quot;as is,&quot; with all faults, and <span className="font-semibold">OFFBEAT
  TECHNET PRIVATE LIMITED</span> express no representations or warranties, of any
  ...
  you.
      ...
      <h2 className=" text-2xl font-semibold">Variation of Terms</h2>
